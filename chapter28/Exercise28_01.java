...
public class Exercise28_01 
{
	public static void main(String[] arg) throws Exception
	{
		...
		int numberOfVertices = graphFile.nextInt();
		
		graphFile.nextLine();
	
		ArrayList<Integer> vertices = new ArrayList<>(numberOfVertices);	//vertices
		ArrayList<AbstractGraph.Edge> edges = new ArrayList<>();	//edges
		
		
		for (int i = 0; i < numberOfVertices; i++) 
		{
			Scanner inputV = new Scanner(graphFile.nextLine());
			int vertex = inputV.nextInt();
			vertices.add(vertex);
			while(inputV.hasNext()) 
			{
				edges.add(new AbstractGraph.Edge(vertex, inputV.nextInt()));
			}
			inputV.close();
		}
		...
		System.out.print("The number of vertices is " + numberOfVertices + "\n");
...
abstract class AbstractGraph<V> implements Graph<V> 
{
	  ...
	  public void printEdges() {
	    for (int u = 0; u < neighbors.size(); u++) {
	      System.out.print("Vertex " + getVertex(u) + " (" + u + "): ");
